...
async function runSandbox(report, initialAudit) {
  ...
  const captionReset = document.getElementById("radar-caption");
  if (captionReset) captionReset.textContent = "◎ correlating signal sources…";
  ...
  if (caption) caption.textContent = "✓ signal correlation complete — core stabilized";
